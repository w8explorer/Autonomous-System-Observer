...
"""
AI-CodeCompass Guardian — Autonomous System Monitoring
Location: /home/ubuntu/AI-CodeCompass/guardian.py
...
DB_PATH     = "/home/ubuntu/guardian_memory.db"
VECTOR_DB   = "/home/ubuntu/guardian_vectors"
THREAD_ID   = "guardian-v2"
...
FILES = [
    ...
    },
    {
        ...
        "path": "/home/ubuntu/guardian_crew.py",
    },
    {
        "label": "Filesystem Scanner",
        "path": "/home/ubuntu/guardian_scan.sh",
    },
    {
        "label": "AI Server Launcher",
        "path": "/home/ubuntu/start_guardian_brain.sh",
    },
    {
        "label": "Guardian Security State",
...
# ── NODE 1: Read Files ─────────────────────────────────────────────────────────
def read_files(state: GuardianState) -> dict:
...
def human_review(state: GuardianState) -> dict:
...
def analyse(state: GuardianState) -> dict:
    ...
    system = SystemMessage(content=(
        "You are an Autonomous System Guardian. "
...
def write_digest(state: GuardianState) -> dict:
    ...
    full = f"""# 🗂️ AI-CodeCompass Guardian — Project Memory Digest
*Auto-generated on {ts} by `/home/ubuntu/AI-CodeCompass/guardian.py`*

> Run `python3 /home/ubuntu/AI-CodeCompass/guardian.py` anytime to refresh.
> Memory DB: `{DB_PATH}`
> Vector DB: `{VECTOR_DB}`
{struct_meta}
...
|---------|-------------|----------|
| `python3 guardian.py` | Refresh this digest | `/home/ubuntu/AI-CodeCompass/guardian.py` |
| `python3 guardian.py --auto` | Skip human pauses | — |
...
if __name__ == "__main__":
    _divider("Ubuntu Guardian — Project Memory (LangGraph)", CY)
    print(f"{CY}{B}  Script  :{R} /home/ubuntu/guardian.cre.py")
